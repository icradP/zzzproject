...
class AppAssets {
  ...
  static const List<String> fallbackAvatarPool = [
    ...
    '${_characters}npcs/SageInABarrel.png',
  ...
  static const Map<String, String> smokeAccountAvatars = {
    ...
    // Common aliases used by smoke scripts. Keeping these explicit prevents
    // a short-lived test account set from hashing onto the same portrait.
    'smoke-1': '${_characters}npcs/Sjal1.png',
    'smoke-2': '${_characters}npcs/Sjal2.png',
    'smoke-3': '${_characters}npcs/Sjal3.png',
    'smoke-test': '${_characters}npcs/SageInABarrel.png',
    'smoke-test-1': '${_characters}npcs/Elfy.png',
    'smoke-test-2': '${_characters}npcs/Foamy.png',
    'smoke-user-1': '${_characters}npcs/Heddy.png',
    'smoke-user-2': '${_characters}npcs/OfficerMewmew.png',
    'smoke-user-3': '${_characters}temp/GraceHoward.png',
    'smoke-a': '${_characters}npcs/Sjal2.png',
    'smoke-b': '${_characters}npcs/Sjal3.png',
    'test-user': '${_characters}temp/KoledaBelobog.png',
    'test-user-1': '${_characters}temp/Soldier11.png',
    'test-user-2': '${_characters}temp/Soukaku.png',
    'user-a': '${_characters}Lucy.png',
