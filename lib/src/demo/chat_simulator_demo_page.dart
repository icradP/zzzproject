...
import 'package:zzzproject/src/chat/system_message_widgets.dart';
import 'package:zzzproject/src/models/chat_models.dart';
import 'package:zzzproject/src/theme/zzz_colors.dart';
import 'package:zzzproject/src/utils/iterable_extensions.dart';
import 'package:zzzproject/src/widgets/zzz_widgets.dart';

/// Legacy ZZZ-Chat simulator kept as a demo / QA page.
class ChatSimulatorDemoPage extends StatefulWidget {
  const ChatSimulatorDemoPage({super.key});

  static const routeName = '/demo';

  @override
  State<ChatSimulatorDemoPage> createState() => _ChatSimulatorDemoPageState();
}

class _ChatSimulatorDemoPageState extends State<ChatSimulatorDemoPage>
  ...
  Future<void> _loadCharacters() async {
    try {
      final raw = await rootBundle.loadString(AppAssets.charactersJson);
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: const Icon(Icons.science_outlined, color: Colors.black),
          ),
    ...
    return ZzzSegmentedControl<String>(
      ...
      items: const [
        ZzzSegmentItem<String>(
          value: 'profiles',
          tooltip: 'Profiles',
          iconAsset: AppAssets.iconAgentProfile,
          enabled: false,
        ),
        ZzzSegmentItem<String>(
          value: 'dm',
    ...
    return Column(
      children: [
        _identityPill(
          ...
          fallbackAsset: AppAssets.characterWise,
    ...
    return Column(
      children: [
        _identityPill(
          ...
          fallbackAsset: AppAssets.characterBelle,
  ...
  Widget _buildMessageRow(int index) {
    ...
    final avatar = ZzzAvatar(
      image: _imageForIdentity(
        sender,
        isLeft ? AppAssets.characterWise : AppAssets.characterBelle,
      ),
      size: 42,
    );
    ...
    return Row(
      children: [
        ...
        IconButton.filled(
          ...
          icon: Image.asset(AppAssets.iconPhoto, width: 24),
        ),
      ],
    );
  }
