...
abstract class ImMessageSource {
  ...
  /// Realtime in-place content updates. Consumers can rebuild only the
  /// affected bubble instead of replacing the whole conversation snapshot.
  ...
  /// Persists a Dynamic Content response generated by the local Agent.
  ///
  /// Sources that route messages to a remote assistant can override this to
  /// add a local-agent marker, preventing the response from being processed as
  /// a new remote prompt.
  ...
  Future<ImMessage> sendDynamicUpdate({
    ...
    throw UnsupportedError(
      'Dynamic content updates are not supported by this source.',
    );
  }
  ...
  Future<ImMessage> replaceDynamicContent({
    ...
    throw UnsupportedError(
      'Dynamic content replacement is not supported by this source.',
    );
  }
  ...
  Future<ImMessage> removeDynamicContent({
    ...
    throw UnsupportedError(
      'Dynamic content removal is not supported by this source.',
    );
  }
